...
exports.addBookController = async (req,res)=>{
    ...
    //check books existing
    const existingBook = await books.findOne({title,sellerMail})
    //if books is already exist : send response as denied
    if(existingBook){
...
exports.bookPaymentController = async (req,res) =>{
    ...
    success_url: 'https://bookstore-dec25.vercel.app/success',
    cancel_url: 'https://bookstore-dec25.vercel.app/cancel',
    line_items,
    mode: 'payment',
